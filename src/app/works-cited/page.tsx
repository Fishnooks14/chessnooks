        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="text-gray-700">
            ...
            <p className="mb-4">
              ...
              www.thechesswebsite.com/chess-openings/. Accessed 7 Mar. 2024.
            </p>
            <p className="mb-4">
              Team, Chess.com. “The Best Chess Games of All Time.” Chess.Com,
              Chess.com, 14 Dec. 2022,
              www.chess.com/article/view/the-best-chess-games-of-all-time.
            </p>
            <p className="mb-4">
              “Simplified Evaluation Function.” Simplified Evaluation Function -
              Chessprogramming Wiki, 16 May 2018,
