...
const sections: Section[] = [
    ...
    <img>@@@@@@ INSERT IMAGE OF JUST ROOK IN CORNER HERE @@@@@</img>
    <p><br /> Next, along the row labled "1" (or any row in the case of an unlabeled board), place white's pieces in the following order: <i>Knight, Bishop, Queen, King, Bishop, Knight, Rook</i></p>
    <img>@@@@@@ INSERT IMAGE OF WHITE'S PIECES HERE @@@@@</img>
    <p><br />Now, mirror white's pieces for black on the opposite side of the board:</p>
    <img>@@@@@@ INSERT IMAGE OF BOTH SIDES'S PIECES HERE @@@@@</img>
    <p><br />Finally, place a row of pawns on both sides to complete the board setup.</p>
    <img>@@@@@@ INSERT FULLY SET BOARD HERE @@@@@</img>`,
    },
    {
        title: "Pieces",
    ...
    },
    {
        ...
        subsections: [
            ...
            {
                title: "Checkmate",
                content: `<p><br /> A checkmate occurs when a player's king is under attack, but they have no valid moves to get their king out of danger. In ths case, the player under attack loses to his/ her opponent.
                </p>`,
            },
            {
                title: "Stalemate",
            ...
            {
                title: "Unsufficient Material",
                content: `<p><br />If there is no possible way for either player to put their opponent in checkmate with their remaining pieces, the game will end due to unsufficient material. This results in a draw.</p>`,
            },
        ],
    },
    {
